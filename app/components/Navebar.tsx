...
export default function Navebar() {
  ...
  return (
    <Disclosure as="nav">
      {({ open }) => (
        <>
          <div className="max-w-6xl mx-auto px-[16px] sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex justify-between w-full">
                <div className="flex items-center">
                  <Link href="/">
                    <h1 className="text-2xl font-medium">
                      Swarnadeep <span className="text-teal-500">Roy</span>
                    </h1>
                  </Link>
                </div>
            ...
            <div className="pt-2 pb-3 space-y-1">
              <Link
                ...
                className={`${
                  pathname == "/"
                    ...
                    : "border-transparent text-grat-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 dark:hover:bg-gray-700"
                }`}
              >
                Home
              </Link>
              <Link
                ...
                className={`${
                  pathname == "/projects"
                    ? "bg-teal-50 border-teal-500 text-teal-500 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:bg-gray-800"
                    : "border-transparent text-grat-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-white block pl-3 pr-4 py-2 dark:hover:bg-gray-700 border-l-4 text-base font-medium dark:text-white"
                }`}
              >
                Projects
              </Link>
